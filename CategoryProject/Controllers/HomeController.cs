...
namespace CategoryProject.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            new ProductDto { Id = 1, Name = "Bánh kem nhân dâu", Description = $"Như 1 trái dâu tươi đỏ mọng", Price = 335000, ImageURL = "/images/Banh-Kem-Dau-1.jpg", CreatedDate = new DateOnly(2024,11,08) },
            new ProductDto { Id = 2, Name = "Bánh quy bơ đậu phộng", Description = $"Thơm ngon giòn béo", Price = 25000, ImageURL = "/images/Quy-Bo-Dau-Phong-2.jpg", CreatedDate = new DateOnly(2024,11,08) },
            new ProductDto { Id = 2, Name = "Bánh Flan", Description = $"Núng nính tan mềm trên đầu lưỡi", Price = 12000, ImageURL = "/images/Banh-Flan-2.jpg", CreatedDate = new DateOnly(2024,11,08) },
        };
